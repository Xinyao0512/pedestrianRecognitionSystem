...
print("advanceDetector")

def advancedPro (path, a):

    # 根据视频尺寸，填充一个polygon，供撞线计算使用
    mask_image_temp = np.zeros((1080, 1920), dtype=np.uint8)

    # 初始化2个撞线polygon
    list_pts_blue = [[0, 0], [0, 0]]
    # list_pts_blue = [[20, 0], [60, 0], [60, 1080], [20, 1080]]
    ...
    # 填充第二个polygon
    mask_image_temp = np.zeros((1080, 1920), dtype=np.uint8)
    list_pts_yellow = [[0, 0], [0, 0]]
    # list_pts_yellow = [[1860, 0], [1900, 0], [1900, 1080], [1860, 1080]]
    ...
    draw_text_postion = (int(1280 * 0.01), int(720 * 0.05))
    ...
    while True:
        ...
        text_draw = 'AREA1: ' + str(down_count) + \
                    ' , AREA2: ' + str(up_count)
        ...
        cv2.imshow('Advanced Detector', output_image_frame)
        # cv2.waitKey(1)
